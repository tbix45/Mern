...
const OnePetDetails = (props) => {
    ...
    let [petLikes, setPetLikes] = useState(0);
    ...
    return (
        <div>
            ...
            <div className="pet-card">
                ...
                <p>{petLikes} Like(s)</p>
                {liked ?
                    <button onClick={(e) => likePet(e, petDetails._id)} liked={liked} setLiked={setLiked} className="btn btn-success" disabled>Like {petDetails.name} the {petDetails.type}</button>
                    :
                    <button onClick={(e) => likePet(e, petDetails._id)} liked={liked} setLiked={setLiked} className="btn btn-success">Like {petDetails.name} the {petDetails.type}</button>
                }
